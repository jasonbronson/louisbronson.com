...
<div class="section services">
    <div class="container">
        <div class="row">
            <div class="col-md-6"><img class="img-fluid" src='<?php echo get_template_directory_uri(); ?>/img/plumber2.jpg'> </div>
            <div class="col-md-6 services-wording">
                <h2>Plumbing & Electrical Services</h2>
                <p>Louis Bronson has been handling electrical services and plumbing for about 48 years now. His motto is "Do it right or don't do it at all". We work around Glens Falls, NY, Saratoga Springs, NY, Ballston Spa, NY, Lake George, NY and surrounding areas. </p>
                <p>All our work done for plumbing is the highest quality plumbing job. We have A+ Ratings with BBB, Angies List, Porch.com. We're licensed by the City of Glens Falls for professional plumbing. We're also fully insured but have never in 48 years needed to use it. We stand behind our work and will make sure you're happy with the job done.</p>
                <br>
                <h1></h1>
                <p></p>
            </div>
